                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <select name="import_example" id="import_example" class="form-control mkdf-form-element dependence">
                                                    <option value="landing">Burst Intro</option>
                                                    <option value="burst">Burst Original</option>
                                                    <option value="burst1">Burst 1 - One Page</option>
                                                    <option value="burst2">Burst 2 - Left Menu</option>
                                                    <option value="burst3">Burst 3 - Classic</option>
                                                    <option value="burst4">Burst 4 - Standard</option>
                                                    <option value="burst5">Burst 5 - Passepartout</option>
                                                    <option value="burst6">Burst 6 - Split</option>
                                                    <option value="burst7">Burst 7 - Shop</option>
                                                    <option value="burst8">Burst 8 - Masonry</option>
                                                    <option value="burst9">Burst 9 - Blog</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
