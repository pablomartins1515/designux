<div class="mkdf-page-header page-header clearfix">
    ...
    <div class="mkdf-theme-name pull-left" >
        <img src="<?php echo esc_url(mkd_burst_get_skin_uri() . '/assets/img/logo.png'); ?>"
        ...
        <div class="mkdf-top-section-holder-inner">
            ...
            <div class="mkdf-top-buttons-holder">
                <?php if($showSaveButton) { ?>
                    <input type="button" id="mkd_top_save_button" class="btn btn-info btn-sm" value="<?php esc_html_e('Save Changes', 'burst'); ?>"/>
                <?php } ?>
            </div>
        </div>
    </div>
