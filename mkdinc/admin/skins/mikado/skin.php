...
class MikadoBurstSkin extends MikadoBurstSkinAbstract {
    /**
     * Skin constructor. Hooks to mkd_burst_admin_scripts_init and mkd_burst_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('mkd_burst_admin_scripts_init', array($this, 'registerStyles'));
        add_action('mkd_burst_admin_scripts_init', array($this, 'registerScripts'));

        add_action('mkd_burst_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('mkd_burst_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('mkd_burst_enqueue_meta_box_styles', array($this, 'enqueueMetaStyles'));
        add_action('mkd_burst_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            mkd_burst_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            mkd_burst_register_skin_style($styleHandle, $stylePath);
        }
    ...
    public function renderOptions() {
        ...
        $tab    		= mkd_burst_get_admin_tab();
        $active_page 	= $mkd_burst_Framework->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
*@param MikadoBurstAdminPage $page current page to load
...
*@param MikadoBurstAdminPage $page current page to load
    ...
    public function renderImport() { ?>
        <div class="mkdf-options-page mkdf-page">
            <?php $this->getHeader(mkd_burst_get_theme_info_item('Name'), mkd_burst_get_theme_info_item('Version'), false); ?>
            <div class="mkdf-page-content-wrapper">
                <div class="mkdf-page-content">
                    <div class="mkdf-page-navigation mkdf-tabs-wrapper vertical left clearfix">
