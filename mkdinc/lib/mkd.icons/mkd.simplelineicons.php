...
class MikadoBurstSimpleLineIcons implements iMikadoBurstIconCollection {
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = MIKADO_ROOT . "/css/simple-line-icons/simple-line-icons.css";
    }
    ...
    public function render($icon, $params = array()) {
        ...
        $html .= '<i class="mkd_icon_simple_line_icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString .
            '></i>';
