...
$html .= '<div class="mkd_pricing_list" '.$background_style.'>';
	if($title !=''){
		$html .='<div class="mkd_pricing_list_title"><span>'.$title.'</span></div>'; // close div.mkd_pricing_list_title
	}	
	$html .='<ul class="mkd_pricing_list_holder '.$type.'">';
		$html .= do_shortcode($content);
	$html .='</ul>'; // close ul.mkd_pricing_list_holder
$html .= '</div>'; // close div.mkd_pricing_list
