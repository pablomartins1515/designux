...
$html = '<div class="mkd_animated_elements_holder" style="' .$animated_elements_holder_style. ' ' .$border_style. '" data-animation="' .$animation_type. '" data-animation-time="' .$animation_time. '" data-border-color="' .$border_color. '" data-border-width="' .$border_width. '">';
